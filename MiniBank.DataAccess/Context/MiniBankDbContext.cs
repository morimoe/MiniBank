    ...
    public class MiniBankDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, Name = "Test User1", Email = "test1@minibank.com", PasswordHash = "$2a$11$U62BKHFnsQZutN5WVy3XaukmPrGzOS4Xc.yudqZlU0XV9f19JYK92" },
                new User { Id = 2, Name = "Test User2", Email = "test2@minibank.com", PasswordHash = "$2a$11$Svw55ZLBpVfb29IOdOCKLeiLRAbbXcW0WgDT/4E21HPc0hS2e2y/K" }
            );
